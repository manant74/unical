...
- Creato `utils/genius_engine.py`: motore per la generazione, persistenza e gestione dei piani (fasi, step, tasks, verifiche, beliefs collegati)
- Creati prompt dedicati:
  ...
  - `genius_step_tips_prompt.md` — generazione di consigli pratici per ogni step
- Supporto per il riutilizzo di BDI framework esportati da Compass (`data/bdi_frameworks/`)
...
- **Rigenerazione Intentions**: aggiornata la generazione delle Intentions per il use case delle perizie immobiliari con BDI completo
...
- Implementazione regole di Rubric all'interno della logica del Validator
...
- Grafo delle relazioni BDI più interattivo con la possibilità di interagire con nodi, archi e label e renderizzare in più modalità il grafo
